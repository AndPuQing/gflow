  ...
  locales: {
    ...
    'zh-CN': {
      ...
      themeConfig: {
        nav: [
          { text: '首页', link: '/zh-CN/' },
          { text: '快速开始', link: '/zh-CN/getting-started/installation' },
          { text: '用户指南', link: '/zh-CN/user-guide/job-submission' },
          { text: '参考文档', link: '/zh-CN/reference/quick-reference' }
        ],
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'gbatch 参考', link: '/zh-CN/reference/gbatch-reference' },
              { text: 'gqueue 参考', link: '/zh-CN/reference/gqueue-reference' },
              { text: 'gcancel 参考', link: '/zh-CN/reference/gcancel-reference' },
              { text: 'ginfo 参考', link: '/zh-CN/reference/ginfo-reference' }
            ]
          }
        ],
